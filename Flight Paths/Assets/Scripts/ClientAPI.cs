...
public class ClientAPI : MonoBehaviour
{
    ...
    List<string> countryCodes = new List<string> () {"EG", "US", "DE", "GR", "FR", "CH", "BR", "GB", "AU", "CA", "RU", "JP", "TR", "UK", "TH", "MX", "PH", "DZ", "AE", "ZA", "KR", "ES", "AR", "IN"};
        ...
        using(UnityWebRequest www = UnityWebRequest.Get(url))
        {
            ...
            else
            {
                if (www.isDone)
                {
                    ...
                    for (int i = 0; i < 100; i++)
                    {
                        bool hasCCto = countryCodes.Contains(N["data"][i]["to"]["country"]["cc"]);
